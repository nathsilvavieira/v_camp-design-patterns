...
public class RoadShipping extends Shipping{
    ...
    public RoadShipping(double shippingPrice, double weight, double purchasePrice, int quantityOfProducts, LocalDateTime deliveryDate) {
