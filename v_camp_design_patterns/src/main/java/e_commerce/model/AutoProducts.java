...
public class AutoProducts extends Product {

    private String categoryEletronic;
    private String subCategoryEletronic;

    public AutoProducts(String name, String sku, double price, double weight, String categoryEletronic, String subCategoryEletronic) {
